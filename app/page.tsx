...
import SafeWordPanel from "@/components/SafeWordPanel";
import {
...
function assessmentFromProgress(
  progress: UserProgress | null,
): AssessmentSnapshot | null {
  return progress?.assessment ?? null;
}
...
export default function Home() {
  ...
  const assessment = assessmentFromProgress(progress);
